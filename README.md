...
This project was created as a personal challenge: **Can I learn a new tech stack and deliver a functional iOS MVP in less than 24 hours?** I completely designed, programmed, and deployed the app to a real device in **16 hours of pure development time**. To achieve this speed, I heavily utilized modern AI coding assistants, which allowed me to skip tedious boilerplate code and focus exclusively on complex business logic (state management, interval timers) and UI/UX.
